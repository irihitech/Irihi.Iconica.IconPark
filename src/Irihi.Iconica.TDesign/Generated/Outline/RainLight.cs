...
public class RainLight : TDesignIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M7.99805 13.998H8.00195V14.002H7.99805V13.998Z"),
        },
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M11.998 11.998H12.002V12.002H11.998V11.998Z"),
        },
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M15.998 13.998H16.002V14.002H15.998V13.998Z"),
        },
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M15.998 17.998H16.002V18.002H15.998V17.998Z"),
        },
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M11.998 15.998H12.002V16.002H11.998V15.998Z"),
        },
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M11.998 19.998H12.002V20.002H11.998V19.998Z"),
        },
        new PathDrawingElement()
        {
            StrokeIndex = 1,
            Data = StreamGeometry.Parse(
                "M7.99805 17.998H8.00195V18.002H7.99805V17.998Z"),
        },
    ];
