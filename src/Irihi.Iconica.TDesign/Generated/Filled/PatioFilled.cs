...
public class PatioFilled : TDesignIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            FillIndex = 0,
            Data = StreamGeometry.Parse(
                "M11 18H9V16.5H11V18Z"),
        },
        new PathDrawingElement()
        {
            FillIndex = 0,
            Data = StreamGeometry.Parse(
                "M11 14.5H9V13H11V14.5Z"),
        },
    ];
