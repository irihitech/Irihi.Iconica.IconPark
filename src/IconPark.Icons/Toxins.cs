...
public class Toxins: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = false,
            Data = StreamGeometry.Parse(
                "M18 27.0002C20.2091 27.0002 22 25.2094 22 23.0002L18 19.0002C15.7909 19.0002 14 20.7911 14 23.0002C14 25.2094 15.7909 27.0002 18 27.0002Z")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 45,
            ...
            InheritStrokeJoin = false,
            Data = StreamGeometry.Parse(
                "M32 27.0002C29.7909 27.0002 28 25.2094 28 23.0002L32 19.0002C34.2091 19.0002 36 20.7911 36 23.0002C36 25.2094 34.2091 27.0002 32 27.0002Z")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 45,
            ...
            Data = StreamGeometry.Parse(
                "M22 34.0002L24.9379 31.0002L28 33.8965")
        },
    ];
