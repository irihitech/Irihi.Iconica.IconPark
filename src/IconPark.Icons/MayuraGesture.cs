...
public class MayuraGesture: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M14.0059 24.0002V10.0002C14.0059 8.34567 15.3471 7.00439 17.0017 7.00439C17.0031 7.00439 17.0045 7.0044 17.0059 7.0044C18.6634 7.0067 20.0059 8.35105 20.0059 10.0086V24.0002")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 0,
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M26.0073 20.0195V19.0195C26.0073 17.3627 27.3505 16.0195 29.0073 16.0195C30.6642 16.0195 32.0073 17.3627 32.0073 19.0195V20.0195")
        },
    ];
