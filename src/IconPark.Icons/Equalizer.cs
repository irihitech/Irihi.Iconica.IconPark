...
public class Equalizer: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            Data = StreamGeometry.Parse(
                "M11 16C13.7614 16 16 13.7614 16 11C16 8.23858 13.7614 6 11 6C8.23858 6 6 8.23858 6 11C6 13.7614 8.23858 16 11 16Z")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 0,
