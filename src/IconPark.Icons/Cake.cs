...
public class Cake: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M8 27V40C8 41.1046 8.89543 42 10 42H38C39.1046 42 40 41.1046 40 40V27")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 45,
        ...
        new PathDrawingElement()
        {
            ...
            Data = StreamGeometry.Parse(
                "M27 8C26.2 4 24.0001 4 24.0001 4C24.0001 4 21.8008 4 21.0008 8C20.0008 13 28 13 27 8Z")
        },
    ];
