...
public class Compression: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M4 15C5.5 17 5.99988 21 5.99988 24C5.99988 27 5.5 31 4 33")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 45,
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M44 15C42.5 17 42.0001 21 42.0001 24C42.0001 27 42.5 30 44 33")
        },
    ];
