...
public class Youtobe: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = false,
            Data = StreamGeometry.Parse(
                "M22.5735 29.8986C21.9107 30.3625 21 29.8884 21 29.0793V18.9207C21 18.1116 21.9107 17.6375 22.5735 18.1014L29.8297 23.1808C30.3984 23.5789 30.3984 24.4211 29.8297 24.8192L22.5735 29.8986Z")
        },
    ];
