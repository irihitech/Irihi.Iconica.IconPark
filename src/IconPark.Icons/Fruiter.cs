...
public class Fruiter: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M16 44C23.0933 31.0694 18.9556 25.3469 16 24L30 22C23.28 31.3388 26.5778 40.5578 29.0667 44H16Z")
        },
    ];
