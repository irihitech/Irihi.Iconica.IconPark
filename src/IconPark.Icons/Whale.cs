...
public class Whale: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M5 28C7.83333 28.5321 13.4 29.5542 17 27")
        },
    ];
