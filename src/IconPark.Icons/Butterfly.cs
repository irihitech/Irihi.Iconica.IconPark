...
public class Butterfly: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M24.0322 23C23.534 17.8642 28.9135 7 33 7")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 45,
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M23.9678 23C24.466 17.8642 19.0865 7 15 7")
        },
    ];
