...
public class Vacation: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M24 15C23.2454 18.8889 22.1889 28.5333 24 36")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 0,
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M12 41.9992H36C31.2134 37.4146 29 36.0048 24 36C19 35.9952 13.892 39.3817 12 41.9992Z")
        },
    ];
