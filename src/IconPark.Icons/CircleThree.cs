...
public class CircleThree: IconParkIconBase
{
    ...
    [
        ...
        new PathDrawingElement()
        {
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M24 13C26.2091 13 28 11.2091 28 9C28 6.79086 26.2091 5 24 5C21.7909 5 20 6.79086 20 9C20 11.2091 21.7909 13 24 13Z")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 0,
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M9 43C11.2091 43 13 41.2091 13 39C13 36.7909 11.2091 35 9 35C6.79086 35 5 36.7909 5 39C5 41.2091 6.79086 43 9 43Z")
        },
        new PathDrawingElement()
        {
            StrokeIndex = 0,
            ...
            InheritStrokeJoin = true,
            Data = StreamGeometry.Parse(
                "M39 43C41.2091 43 43 41.2091 43 39C43 36.7909 41.2091 35 39 35C36.7909 35 35 36.7909 35 39C35 41.2091 36.7909 43 39 43Z")
        },
    ];
