...
public abstract class IconicaBase : Avalonia.Controls.Control
{
    public static readonly StyledProperty<IBrush?> OuterStrokeProperty =
        AvaloniaProperty.Register<IconicaBase, IBrush?>(
    ...
    static IconicaBase()
    {
        ...
        AffectsRender<IconicaBase>(ModeProperty);
    }

    protected IconicaBase()
    {
