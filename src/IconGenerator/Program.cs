...
static string GenerateDocument(string name, List<DrawingElement> drawingElements)
{
    ...
    sb.AppendLine("// AutoGenerated by IRIHI Iconica IconPark IconGenerator");
    sb.AppendLine("// Design CopyRight 2025 IconPark Authors");
    ...
    sb.AppendLine("using Irihi.Iconica.IconPark;");
    sb.AppendLine();
    sb.AppendLine("namespace Irihi.Iconica.IconPark.Icons;");
    sb.AppendLine();
    sb.AppendLine($"public class {name}: IconParkBase");
    sb.AppendLine("{");
